...
OWNER_NUMBER: process.env.OWNER_NUMBER || "923046123264", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "Imran Salara", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "Imran Salara", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "𝐈-𝐌𝐃💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "Imran-𝐌𝐃", // Input Yours custom...(Maintain font for Flow)
